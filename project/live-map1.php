...
<head>
    ...
    <style>
        ...
        .hero {
            ...
            align-items: center;
            height: 450px; /* Sesuaikan tinggi hero */
            background-image: url('your-hero-image.jpg'); /* Ganti dengan URL gambar hero */
        ...
        #map {
            width: 90%; /* Atur lebar sesuai kebutuhan */
        ...
        .available {
            background-color: #4CAF50; /* Hijau untuk tersedia */
        }

        .occupied {
            background-color: #F44336; /* Merah untuk terisi */
        }
        .booked {
    ...
    <script>
        ...
        setInterval(fetchParkingStatus, 2000); // Memperbarui setiap 2 detik
    </script>
</head>
<body>
